...
object MimeTypeUtils {
    ...
    val MIME_TYPE_DEFAULT: String = "application/octet-stream"
    val MIME_TYPE_JSON: String = "application/json"
    val MIME_TYPE_K_V: String = "application/x-www-form-urlencoded"
